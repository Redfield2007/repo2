...
print("Необходимо ответить на 10 вопросов подряд, в случае успеха, вас ждет приз в 1 миллиард.")
print("У каждого вопроса есть четыре варианта ответа. Нужно напечатать, на ваш взгляд, правильный и нажать ввод.")
print("")
i = 0
while i < 2:
    ...
    print("Вы победили, ответив на все вопросы! Берите уже ваш миллиард")
